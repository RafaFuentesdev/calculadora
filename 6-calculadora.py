...
def main():
    ...
    opciones = ["Sumar", "Restar", "Multiplicar", "Dividir", "Ver Historial", "Salir"]
    funciones = [sumar, restar, multiplicar, dividir, mostrar_historial, salir]
    ...
    while True:
        ...
        if indice_seleccionado != len(opciones) - 1:  # Si la opción no es 'Salir'
            ...
            print("=" * 30)  # Línea separadora
            if indice_seleccionado != 4:  # Si la opción no es 'Ver Historial'
